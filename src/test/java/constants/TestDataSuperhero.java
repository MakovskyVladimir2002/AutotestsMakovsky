...
public class TestDataSuperhero {

    public static final int NOT_EXISTED_ID = -1;
    public static final int WITH_VALID_DATA1 = 4466;
    public static final SuperheroModel SUPERHERO_VALID_WITHOUT_PHONE = new SuperheroModel(128, "Anton Egorov", "1988-04-08", "Russia, Saint Petersburg", "QA", SuperheroModel.Gender.M.name(), null);

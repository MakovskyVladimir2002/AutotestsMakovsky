...
public class PlaywrightTests {
    ...
    static void launchBrowser() {
        playwright = Playwright.create(); // Создаём экземпляр
        browser = playwright.chromium().launch(new BrowserType.LaunchOptions().setHeadless(false)); // Теперь можно вызвать chromium()
    }
